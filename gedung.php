...
<awak>
<judul>
	<font color="6bb9f0"> LAPORAN GEDUNG </font>
</judul><br><br>
<a href="ingedung.php"><button class="btn button"><span class="fa fa-plus"></span><b> Input</b></button></a>
<br>
...
<table class="table table-condensed">
	...
	?>
		...
		<td><a href="edtgedung.php?no=<?php echo $jadi['no'];?>"><button class="btn btn-primary"><span class="fa fa-edit"></span></button></a></td>
		</tr>
	<?php
	}
	?>
