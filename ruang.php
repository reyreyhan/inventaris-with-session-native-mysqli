...
<awak>
<judul>
	<font color="6bb9f0"> LAPORAN RUANG </font>
</judul><br><br>
<a href="inruang.php"><button class="btn button"><span class="fa fa-plus"></span><b> Input</b></button></a>
<br>
...
<table class="table table-condensed">
	...
	?>
		...
		<td><?php echo $jadi['nm_ruang']?></td>
		<td><a href="edtruang.php?no=<?php echo $jadi['no'];?>"><button class="btn btn-primary"><span class="fa fa-edit"></span></button></a></td>
		</tr>
	<?php
	}
	?>
